...
col_data <-
    SingleCellExperiment::colData(h5ad) |> as_tibble(rownames = "cell_id")
...
row_data <-
    ...
    as_tibble(rownames = "ens_gid") |>
    mutate(
        mean_expression = Matrix::rowMeans(SummarizedExperiment::assay(h5ad)),
        mean_log_expression =
            Matrix::rowMeans(log1p(SummarizedExperiment::assay(h5ad)))
    )
